...
export const projects: Project[] = [
  {
    ...
    description:
      "Persoenliches Portfolio mit App Router, TypeScript und animierten UI-Komponenten fuer professionelle Praesentation.",
    role: "Full-Stack Entwicklung",
    stack: ["Next.js", "React", "TypeScript", "CSS"],
    result: "Schnelle, wartbare und deploybare Portfolio-Plattform fuer Bewerbungen.",
  ...
  },
  {
    ...
    description:
      "Eigenes Softwareprojekt mit TypeScript-Stack, entwickelt fuer strukturierte Feature-Erweiterung und saubere Wartbarkeit.",
    role: "Frontend & Architektur",
    stack: ["TypeScript", "React", "Node.js"],
    result: "Solide Basis fuer weiteres Produktwachstum und Teamarbeit.",
  ...
  },
  {
    ...
    summary: "Finanz-Tracker mit interaktiven Charts und klarer Budgetuebersicht.",
    description:
      "Web-App zur Verfolgung von Einnahmen, Ausgaben und Ersparnissen mit benutzerfreundlicher Oberflaeche.",
    role: "Frontend & Logik",
  ...
  },
  {
    ...
    summary: "Rechner fuer komplexe mathematische Operationen mit modularer Struktur.",
    description:
    ...
    result: "Stabile Kernlogik fuer komplexe Berechnungen.",
  ...
  },
  {
    id: "impostor-game",
    title: "Impostor Game",
    summary: "Interaktives Party-Spiel inspiriert vom populaeren Impostor-Format.",
    description:
  ...
  },
  {
    ...
    role: "Backend & Logik",
    stack: ["Python"],
    result: "Zuverlaessige Aufgabenverwaltung als solide Backend-Uebung.",
  ...
  },
  {
    ...
    description:
      "Contest-Loesung mit Fokus auf Problemverstaendnis, strukturierte Umsetzung und funktionierendes Endergebnis.",
  ...
  },
  {
    id: "mensa-app",
    title: "Mensa App",
    summary: "Web-App fuer den aktuellen Mensa-Speiseplan der BZZ.",
    description:
      "Mobile-first Anwendung, die Studierenden schnellen Zugriff auf den taeglichen Speiseplan bietet.",
    role: "Frontend Umsetzung",
    stack: ["HTML", "CSS", "JavaScript"],
    result: "Direkter Zugriff auf relevante Tagesinfos fuer den Schulalltag.",
